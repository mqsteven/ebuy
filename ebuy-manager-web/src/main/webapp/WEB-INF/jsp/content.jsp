        ...
        <div data-options="region:'center'" style="padding:5px">
		    ...
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'url',width:60,align:'center',formatter:GEEK.formatUrl">内容连接</th>
		            <th data-options="field:'pic',width:50,align:'center',formatter:GEEK.formatUrl">图片</th>
		            <th data-options="field:'pic2',width:50,align:'center',formatter:GEEK.formatUrl">图片2</th>
		            <th data-options="field:'created',width:130,align:'center',formatter:GEEK.formatDateTime">创建日期</th>
		            <th data-options="field:'updated',width:130,align:'center',formatter:GEEK.formatDateTime">更新日期</th>
		        </tr>
		    </thead>
		</table>
        </div>
...
var contentListToolbar = [{
    ...
    iconCls:'icon-edit',
    handler:function(){
    	var ids = GEEK.getSelectionsIds("#contentList");
    	if(ids.length == 0){
